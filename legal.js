...
const DISCLAIMER_TAXI = `La <b>location simple</b> d'une licence est interdite : seule la <b>location-gérance</b> est admise (ADS délivrées avant le 1ᵉʳ octobre 2014), et le contrat doit être <b>publié dans un journal d'annonces légales</b>. La <b>carte professionnelle</b> est obligatoire pour conduire. Le titulaire reste <b>solidairement responsable</b> des dettes d'exploitation pendant 6 mois après la publication. <b>Taxiloc n'est pas partie au contrat</b> et ne valide aucun arrangement.`;
...
function legalMentions() {
  ...
  <p>Taxiloc est un <b>tableau d'annonces</b> mettant en relation des chauffeurs de taxi professionnels. L'éditeur agit en qualité d'<b>hébergeur de contenus</b> au sens de la LCEN : il n'est pas partie aux transactions entre utilisateurs et n'exerce pas de contrôle éditorial sur les annonces.</p>`;
}
...
function legalConfidentialite() {
  ...
  <h2>Cookies</h2>
  <p>Taxiloc n'utilise que du <b>stockage fonctionnel</b> (mémorisation locale de votre profil et de vos annonces). Aucun traceur publicitaire ni mesure d'audience tierce.</p>`;
}
...
function legalCgu() {
  ...
  <p class="hint">Dernière mise à jour : 2026.</p>
  <h2>1. Objet</h2>
  <p>Taxiloc est une plateforme d'annonces réservée aux chauffeurs de taxi professionnels : location, location-gérance, licence (ADS), remplacement, et matériel/accessoires.</p>
  <h2>2. Rôle de la plateforme</h2>
  <p>Taxiloc est un <b>intermédiaire neutre</b> : elle met en relation une offre et une demande mais <b>n'est pas partie aux contrats</b> conclus entre utilisateurs et ne perçoit <b>aucune commission</b> sur les transactions.</p>
  ...
  <p>Chaque utilisateur est seul responsable de l'exactitude de son annonce et du respect de la réglementation applicable (location-gérance conforme, publication au journal d'annonces légales, carte professionnelle, documents à jour…). Taxiloc ne garantit ni la véracité ni la légalité des annonces.</p>
